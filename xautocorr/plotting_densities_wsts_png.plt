...
set term png size 1650,900 enhanced font "DejaVu Sans Disl,18" truecolor

set o i_dconf_name . "_ts.png"
...
p [-0.5:0.5][-0.5:0.5] "cells_b.tmp" w image, "contour_d.tmp" w l lt -1 lw 1, ifname u ($1):($3>0.0?$2:1/0) with points pt "┻" tc rgb '#c1000e', "" u ($1):($3<0.0?$2:1/0) with points pt "┳" tc rgb '#005893'
unset multiplot
...
p [-0.5:0.5][-0.5:0.5] "cells_c.tmp" w image, ifname u ($1):($3>0.0?$2:1/0) with points pt "┻" tc rgb '#c1000e'

set title "negative (ρ_-)"
set palette negative
p [-0.5:0.5][-0.5:0.5] "cells_d.tmp" w image, ifname u ($1):($3<0.0?$2:1/0) with points pt "┳" tc rgb '#005893'
unset multiplot
